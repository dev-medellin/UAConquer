...
namespace TheChosenProject
{
    public class DiscordMarket
    {
        ...
        public DiscordMarket(string API)
        {
            this.API = API;
        ...
        private void postToDiscordMarket(string Text)
        {
            ...
            Dictionary<string, string> DiscordMarketToPost = new Dictionary<string, string>();
            DiscordMarketToPost.Add("content", Text);

            var content = new FormUrlEncodedContent(DiscordMarketToPost);
