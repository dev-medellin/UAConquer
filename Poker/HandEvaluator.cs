...
namespace HoldemHand
{
    ...
    internal class Hand : IComparable
    {
        ...
        public static string DescriptionFromMask(ulong cards)
        {
            ...
            var sc = (uint) ((cards >> CLUB_OFFSET) & 0x1fffUL);
            var sd = (uint) ((cards >> DIAMOND_OFFSET) & 0x1fffUL);
            var sh = (uint) ((cards >> HEART_OFFSET) & 0x1fffUL);
            var ss = (uint) ((cards >> SPADE_OFFSET) & 0x1fffUL);
        ...
        {
            set { PocketCards = MaskToString(value); }

            get { return ParseHand(PocketCards); }
        }
        ...
        {
            set { Board = MaskToString(value); }

            get { return ParseHand(Board); }
        }
        ...
        {
            get { return DescriptionFromMask(MaskValue); }
        }
        ...
        {
            get { return (HandTypes) HandType(HandValue); }
        }
        ...
        {
            var is_st_or_fl = HandTypes.HighCard;

            var ss = (uint) ((mask >> SPADE_OFFSET) & 0x1fffUL);
            var sc = (uint) ((mask >> CLUB_OFFSET) & 0x1fffUL);
            var sd = (uint) ((mask >> DIAMOND_OFFSET) & 0x1fffUL);
            var sh = (uint) ((mask >> HEART_OFFSET) & 0x1fffUL);

            var ranks = sc | sd | sh | ss;
            uint rankinfo = nBitsAndStrTable[ranks];
            var n_dups = (uint) (cards - (rankinfo >> 2));
            ...
            if ((rankinfo & 0x01) != 0)
            {
                ...
                var t =
                    (uint) (nBitsAndStrTable[ss] | nBitsAndStrTable[sc] | nBitsAndStrTable[sd] | nBitsAndStrTable[sh]);
            ...
            switch (n_dups)
            {
                ...
                default:
                    ...
                    if (is_st_or_fl != 0) return is_st_or_fl;
        ...
        public static uint Evaluate(ulong cards, int numberOfCards)
        {
            ...
            var n_dups = (uint) (numberOfCards - n_ranks);
        ...
        {
            "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs", "Clubs",
            "Clubs",
            ...
            "Hearts", "Hearts",
            "Spades", "Spades", "Spades", "Spades", "Spades", "Spades", "Spades", "Spades", "Spades", "Spades", "Spades",
            "Spades", "Spades"
        };
