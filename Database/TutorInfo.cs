...
namespace TheChosenProject.Database
{
    public class TutorInfo
    {
        ...
        {
            string[] baseText = File.ReadAllLines(ServerKernel.CO2FOLDER + "cq_tutor_type.txt");
            ...
            baseText = File.ReadAllLines(ServerKernel.CO2FOLDER + "cq_tutor_battle_limit_type.txt");
