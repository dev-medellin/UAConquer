...
namespace TheChosenProject.Database
{
    public class InfoDemonExterminators
    {
            ...
            CityQuests.Add(1011, new List<MonsterInfo>()
        {
            ...
            new MonsterInfo(){ ID =9, Name = "FireSpirit" }//9
        });
       ...
       {
       new ushort[] {1/*Pheasants*/,8/*Ratlings*/,14/*Sandmonsters*/ ,55/*97 Bandits*/,9},
       ...
       new ushort[] {3/*Robins*/,10/*Monkeys and Macaques*/,16/*Rock Monsters*/,56/*Bloody Bats*/ }
        ...
        {
       new string[] {"Pheasants","Ratlings","Sandmonsters" ,"97 Bandits","FireSpirit"},
       new string[] {"TurtleDoves","Bandits","Snakemen","Birdmen","FireSpirit"},
