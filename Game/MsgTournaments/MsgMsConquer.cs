...
{
    public class MsgMsConquer
    {
        public const ushort MapID = 9999;
        public const uint RewardConquerPoints = 1000000;
        public const string FilleName = "\\MsConquer.ini";
        ...
        public MsgMsConquer(ProcesType _Proces)
        {
            Proces = _Proces;

            PkWars = new War[(byte)TournamentType.Count][];

            for (TournamentType i = TournamentType.MsConquer; i < TournamentType.Count; i++)
            {
        ...
        internal MsgServer.MsgUpdate.Flags ObtainAura(TournamentType typ)
        {
            switch (typ)
            {
                case TournamentType.MsConquer: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Warrior: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Archer: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Ninja: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Monk: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Pirate: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Fire: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.Water: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.LongLee: return MsgServer.MsgUpdate.Flags.TopMsConquer;
                case TournamentType.WindWalker: return MsgServer.MsgUpdate.Flags.TopMsConquer;
            }
        ...
        internal static TournamentType GetMyTournamentType(Client.GameClient client)
        {
            if (Database.AtributesStatus.IsTrojan(client.Player.Class))
                return TournamentType.MsConquer;
...
#else
                    client.SendSysMesage("You received " + 5000000 + " ConquerMoney", MsgServer.MsgMessage.ChatMode.System, MsgServer.MsgMessage.MsgColor.red);
...
#else
                    MsgSchedules.SendSysMesage("" + client.Player.Name + " Won " + Typ.ToString() + " PK War (" + Level.ToString() + ") , he received Top " + Typ.ToString() + ", " + 5000 + " ConquerPoints and +4 stone !", MsgServer.MsgMessage.ChatMode.TopLeft, MsgServer.MsgMessage.MsgColor.white);
