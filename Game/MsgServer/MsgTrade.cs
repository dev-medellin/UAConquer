...
namespace TheChosenProject.Game.MsgServer
{
    public unsafe static class MsgTrade
    {
        ...
        {
            if (!user.Player.VerifiedPassword)
                return;
            ulong dwParam;
            TradeID ID;
                ...
                case TradeID.RequestAddConquerPointsToTrade:
                    {
                        ...
                        //user.SendSysMesage("You can't trade your points the server only work with (Silvers)!");
                        break;
                    }
                                        ...
                                        if (user.MyTrade.Target.MyTrade.ValidItems())
                                        {
                                            if (user.MyTrade.Target.Inventory.HaveSpace((byte)user.MyTrade.Items.Count))
                                            {
                                                if (user.MyTrade.ValidItems())
                                                {
                                                    ...
                                                    user.Player.Money += (int)user.MyTrade.Target.MyTrade.Money;
                                                    ...
                                                    user.MyTrade.Target.Player.Money += (int)user.MyTrade.Money;
