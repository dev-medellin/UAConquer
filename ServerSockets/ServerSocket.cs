...
namespace TheChosenProject.ServerSockets
{
    public class ServerSocket
    {
        ...
        public void Initilize(ushort MaxBufferSend, ushort MaxBufferReceive)
        {
            this.Connection.ReceiveBufferSize = (int)MaxBufferReceive;
            this.Connection.SendBufferSize = (int)MaxBufferSend;
        }
        ...
        public void Open(ushort port)
        {
            ...
            this.Bruteforce.Init(10);
            this.SPort = (uint)port;
            this.Connection.Bind((EndPoint)new IPEndPoint(IPAddress.Any, (int)port));
            this.Connection.Listen(10);
            this.Connection.Blocking = false;
            this.Connection.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.ReuseAddress, true);
            this.Connection.SetSocketOption(SocketOptionLevel.Tcp, SocketOptionName.Debug, true);
            this.Connection.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.DontLinger, true);
            this.Connection.SetSocketOption(SocketOptionLevel.Socket, SocketOptionName.KeepAlive, true);
            this.Alive = true;
        }
        public void Accept()
        {
