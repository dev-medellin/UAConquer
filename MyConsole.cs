...
namespace TheChosenProject
{
    ...
    public class Console
    {
        ...
        public static extern int DeleteMenu(IntPtr hMen, int nPosition, int wFlags);
        ...
        public static void WriteLine2(object value, params object[] args)
        {
            MyLogger.GameServer.WriteInfo(value.ToString(), args);
        }
  ...
  //      internal static void SetOut(Program.CustomConsole customConsole)
  //      {
